# Subscribes user for news notifications
class SubscribeCommand < BotCommand
  SUBSCRIPTION_MESSAGE = 'Вы подписались на получение уведомлений о срочных новостях. Чтобы отписаться - нажмите соответствующую кнопку в меню.'.freeze
